			...
			columns: [
				{ label: 'First Name', dataField: 'FirstName', width: '25%',
					formatFunction(formatSettings) {
						...
						formatSettings.template =  '<div style="display: flex; align-items: center;"><img style="width: 24px; height: 24px; margin-right: 6px; border-radius: 50%;" class="logo" src="../../../images/phonebook/' + firstName + '.png"/>' + formatSettings.value + '</div>';
					}
				},
