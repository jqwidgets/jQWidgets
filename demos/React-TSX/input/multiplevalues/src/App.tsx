...
const App = () => {
  ...
  const renderer: IInputProps['renderer'] = (itemValue: any, inputValue: any): any => {
  ...
  const source: IInputProps['source'] = (query: any, response: any): any => {
    const item = query.split(/,\s*/).pop();
    myInput.current?.setOptions({ query: item });
    response(countries);
  };
