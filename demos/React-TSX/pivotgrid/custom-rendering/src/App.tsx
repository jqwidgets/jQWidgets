            ...
            filters: [
                {
                    ...
                    filterFunction: (value: any) => value === "Black Tea" || value === "Green Tea"
                }
            ],
...
function App() {
    const itemsRenderer = React.useCallback<IPivotGridProps['itemsRenderer']>(
        (pivotItem) => {
            ...
            if (pivotItem.hierarchy.getSortItem() === pivotItem) {
                const elementClass = pivotItem.hierarchy.getSortOrder() === 'desc'
                    ? "jqx-icon-arrow-down"
                    : "jqx-icon-arrow-up";
    ...
    const cellsRenderer = React.useCallback<IPivotGridProps['cellsRenderer']>(
        (pivotCell) => {
