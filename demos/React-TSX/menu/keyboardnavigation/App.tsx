...
class App extends React.PureComponent<{}> {
    ...
    public render() {
        return (
            <div>
                <JqxMenu theme={'material-purple'} ref={this.myMenu} onItemclick={this.onItemClick}
                    width={600} height={30} showTopLevelArrows={true} keyboardNavigation={true}>
                    <ul>
    ...
    private onItemClick(event: any): void {
        this.eventLog.current!.innerHTML = 'Clicked: ' + event.args.innerText;
    };
}
