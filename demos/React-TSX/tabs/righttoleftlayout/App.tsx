            ...
            <div>
                ...
                >
                    ...
                    <div style={{ textAlign: "right", direction: "rtl" }}>
                        <img src="./../images/avatar.png" style={{ float: "right", margin: 10 }} alt="" />
                    ...
                    <div style={{ textAlign: "right", direction: "rtl" }}>
                        <img src="./../images/endgame.png" style={{ float: "right", margin: 10 }} alt="" />
                    ...
                    <div style={{ textAlign: "right", direction: "rtl" }}>
                        <img src="./../images/twilight.png" style={{ float: "right", margin: 10 }} alt="" />
                    ...
                    <div style={{ textAlign: "right", direction: "rtl" }}>
                        <img src="./../images/unstoppable.png" style={{ float: "right", margin: 10 }} alt="" />
                    ...
                    <div style={{ textAlign: "right", direction: "rtl" }}>
                        <img src="./../images/priest.png" style={{ float: "right", margin: 10 }} alt="" />
