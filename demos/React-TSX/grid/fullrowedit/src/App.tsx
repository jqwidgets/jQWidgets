...
class App extends React.PureComponent<{}, IGridProps> {
        ...
        return (
            <div>
                ...
                <div style={{ fontSize: '12px', fontFamily: 'Verdana', marginTop: '30px' }}>
                    ...
                    <div ref={this.cellEndEditLog} style={{ marginTop: '30px' }} />
                </div>
            </div>
        );
    }
    ...
    private myGridOnCellBeginEdit(event: any): void {
        ...
        if (args.datafield === 'price') {
            this.cellBeginEditLog.current!.innerHTML = 'Begin Row Edit: ' + (1 + args.rowindex) + ', Data: ' + this.rowValues;
        }
    };
    ...
    private myGridOnCellEndEdit(event: any): void {
        ...
        this.rowValues += args.value.toString() + '    ';
        if (args.datafield === 'price') {
            this.cellEndEditLog.current!.innerHTML = 'End Row Edit: ' + (1 + args.rowindex) + ', Data: ' + this.rowValues;
        }
    };
}
