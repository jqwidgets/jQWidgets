...
function App() {
  ...
  const initrowdetails = React.useCallback(
    (index: any, parentElement: any, gridElement: any, datarecord: any): void => {
              ...
              <div style={{ margin: '5px' }}>
                <div style={{ float: 'left', width: '15%' }}>
                  <div style={{ marginTop: '10px' }}>
                    <div className="jqx-rc-all" style={{ margin: '10px' }}>
                      <b>Photo:</b>
                    </div>
                    <img
                      height={60}
                      src={
                        'https://www.jqwidgets.com/react/images/' +
                        datarecord.firstname.toLowerCase() +
                        '.png'
                      }
