...
const App = () => {
    ...
    const columns2: IGridProps['columns'] = [
    ...
    const gridSource = React.useMemo(() => new jqx.dataAdapter(source), [source]);
    const gridSource2 = React.useMemo(() => new jqx.dataAdapter(source2), [source2]);
    ...
    return (
        <JqxTabs theme="material-purple" width={600} height={560}>
            ...
            <div style={{ overflow: 'hidden' }}>
                <JqxGrid theme="material-purple" width="100%" height="100%" source={gridSource} columns={columns} />
            </div>
            <div style={{ overflow: 'hidden' }}>
                <JqxGrid theme="material-purple" width="100%" height="100%" source={gridSource2} columns={columns2} />
            </div>
        </JqxTabs>
    );
};
