...
const App = () => {
    ...
    const columns = useMemo(() => [
        ...
        { text: 'Price', datafield: 'price', aggregates: ['sum'], cellsalign: 'right', width: 100, cellsformat: 'c2' },
        {
            ...
            cellsalign: 'right',
            cellsformat: 'c2',
            cellsrenderer: (row: number, column: any, value: any, defaultRender: string | undefined, rowData: any) => {
                if (value && value.toString().indexOf('Sum') >= 0) {
                    return defaultRender ? defaultRender.replace('Sum', 'Total') : '';
                }
                return '';
            },
            datafield: 'total',
