...
function App() {
  ...
  useEffect(() => {
    const dropDownContent =
      '<div style="position: relative; margin-left: 3px; margin-top: 5px;">DropDownButton</div>';
  ...
  return (
    <div>
      ...
      <JqxCheckBox theme="material-purple" style={{ marginTop: '10px' }} width="30%">
        eLearning
      </JqxCheckBox>
      <JqxCheckBox
      ...
      <JqxRadioButton theme="material-purple" style={{ marginTop: '10px' }} width="30%">
        On
      </JqxRadioButton>
      <JqxRadioButton
        theme="material-purple"
