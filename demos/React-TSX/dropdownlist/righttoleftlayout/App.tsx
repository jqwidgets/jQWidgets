...
class App extends React.PureComponent<{}, IDropDownListProps> {
    ...
    public componentDidMount() {
        const item = this.myDropDownList.current!.getItemByValue('US');
        this.myDropDownList.current!.selectItem(item);
    }

    public render() {
        return (
            <JqxDropDownList theme={'material-purple'} ref={this.myDropDownList}
                width={200} height={30} source={this.state.source} rtl={true} />
        );
    }
}
