...
class App extends React.PureComponent<{}, IListBoxProps> {
    ...
    public componentDidMount() {
        const item = this.myListBox.current!.getItemByValue('US');
        this.myListBox.current!.selectItem(item);
    }

    public render() {
        return (
            <JqxListBox theme={'material-purple'} ref={this.myListBox}
                width={220} height={250} source={this.state.source} checkboxes={true} rtl={true} />
        );
    }
