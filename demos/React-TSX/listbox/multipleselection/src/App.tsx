...
function App() {
    ...
    useEffect(() => {
        myListBox.current?.selectIndex(2);
        myListBox.current?.selectIndex(5);
        myListBox.current?.selectIndex(7);
    }, []);
    ...
    return (
        <div>
            <JqxListBox
                ...
                multiple={true}
            />
            <div ref={selectionLog} style={{ marginTop: '30px', fontSize: '13px', fontFamily: 'Verdana' }} />
        </div>
    );
}
