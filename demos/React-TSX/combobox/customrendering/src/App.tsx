...
class App extends React.PureComponent<{}, IComboBoxProps> {
    ...
    public render() {
        return (
            <JqxComboBox theme={'material-purple'}
                width={270} height={30} source={this.state.source}
                selectedIndex={0} renderer={this.state.renderer} itemHeight={70}
    ...
    private generateData(): any[] {
        ...
        const address = ['507 - 20th Ave. E. Apt. 2A', '908 W. Capital Way', '722 Moss Bay Blvd.', '4110 Old Redmond Rd.', '14 Garrett Hill', 'Coventry House', 'MinerRd.', 'EdgehamHollow', 'WinchesterWay', '4726-11thAve.N.E.', '7HoundstoothRd.'];
