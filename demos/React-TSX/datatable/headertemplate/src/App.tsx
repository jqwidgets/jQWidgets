...
function generateData(): any[] {
    ...
    const city = ['Seattle', 'Tacoma', 'Kirkland', 'Redmond', 'London', 'London', 'UK', 'Seattle', 'London'];
...
const App = () => {
    ...
    const updatingSelection = useRef<boolean>(false);
    const updatingSelectionFromDataTable = useRef<boolean>(false);
    ...
    const columns = React.useMemo<IDataTableProps['columns']>(() => [
        ...
        },
        {
            ...
            cellsRenderer: (row: number, column: string, value: any, rowData: any): string => {
                ...
                const phone = '<div style="margin: 10