...
class App extends React.PureComponent<{}, ITreeGridProps> {
    ...
    constructor(props: {}) {
        ...
        this.state = {
            columns: [
                { align: 'right', cellsAlign: 'right', columnGroup: 'Name', dataField: 'FirstName', minWidth: 100, text: 'FirstName', width: 200 },
                { align: 'right', cellsAlign: 'right', columnGroup: 'Name', dataField: 'LastName', text: 'LastName', width: 200 },
                { align: 'right', cellsAlign: 'right', dataField: 'Title', text: 'Title', width: 160 },
                { align: 'right', cellsAlign: 'right', cellsFormat: 'd', dataField: 'BirthDate', text: 'Birth Date', width: 120 },
                { align: 'right', cellsAlign: 'right', cellsFormat: 'd', dataField: 'HireDate', text: 'Hire Date', width: 120 },
                { align: 'right', cellsAlign: 'right', dataField: 'Address', text: 'Address', width: 250 },
                { align: 'right', cellsAlign: 'right', dataField: 'City', text: 'City', width: 120 },
                { align: 'right', cellsAlign: 'right', dataField: 'Country', text: 'Country', width: 200 }
            ],
            ready: (): void => {
                setTimeout(() => {
