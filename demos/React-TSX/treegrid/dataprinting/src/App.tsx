...
const App = () => {
    ...
    const columns = React.useMemo(() => [
        ...
        { dataField: 'LastName', text: 'LastName', width: 170 },
    ...
    const printClick = React.useCallback(() => {
        const gridContent = myTreeGrid.current!.exportData('html');
        ...
        <div>
            ...
            <div style={{ marginTop: 20 }}>
                <div style={buttonsStyle}>
                    <JqxButton theme={'material-purple'} onClick={printClick}>Print</JqxButton>
                </div>
            </div>
        </div>
    );
