...
class App extends React.PureComponent<{}, ITreeGridProps> {
            ...
            <div>
                ...
                <div style={{ marginTop: 20 }}>
                    <div style={buttonsStyle}>
                        <JqxButton theme={'material-purple'} onClick={this.printClick}>Print</JqxButton>
                    </div >
                </div >
            </div>
        );
    ...
    // Event handling
    private printClick(): void {
        const gridContent = this.myTreeGrid.current!.exportData('html');
