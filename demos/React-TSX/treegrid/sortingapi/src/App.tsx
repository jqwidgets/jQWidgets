...
class App extends React.PureComponent<{}, ITreeGridProps> {
                    ...
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td align={'right'} />
                                <td align={'left'}>
                                    <JqxButton theme={'material-purple'} style={{ float: 'left' }} onClick={this.clickSort}>Sort</JqxButton>
                                    <JqxButton theme={'material-purple'} style={{ float: 'left', marginLeft: 5 }} onClick={this.clickClear}>Clear</JqxButton>
                                </td>
                            </tr>
                        </tbody>
                    </table >
    ...
    // Event handling
    private clickSort(): void {
        const columnIndex = this.columnName.current!.getSelectedIndex();
        const sortOrder = this.sortOrder.current!.getSelectedIndex() === 0 ? 'asc' : 'desc';
        this.myTreeGrid.current!.sortBy(this.columns[columnIndex].dataField, sortOrder);
    }

    private clickClear(event: any): void {
        this.myTreeGrid.current!.sortBy(null);
    }
}
