      ...
      columns: [
        ...
        { dataField: 'City', text: 'City', width: 100 },
        {
          cellsRenderer: (rowKey: number, dataField: any, value: any, data: any) => {
            switch (value) {
              case "USA":
                return "<div style='margin: 0px 20px;'><img style='margin-top: 2px;' width='16' height='16' src='https://www.jqwidgets.com/react/images/usa.png'/></div>";
              case "UK":
                return "<div style='margin: 0px 20px;'><img style='margin-top: 2px;' width='16' height='16' src='https://www.jqwidgets.com/react/images/uk.png'/></div>";
              default:
                return '';
            }
          },
