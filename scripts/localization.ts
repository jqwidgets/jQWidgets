        ...
        default:
            ...
            case 'ru':
                localization = {
                        ...
                        filternumericcomparisonoperators: ['равен', 'не равен', 'меньше чем', 'меньше чем или равен', 'больше чем',
                                                            'больше чем или равен', 'ноль', 'не ноль'],
                        filterdatecomparisonoperators: ['равен', 'не равен', 'меньше чем', 'меньше чем или равен', 'больше чем',
                                                        'больше чем или равен', 'ноль', 'не ноль'],
